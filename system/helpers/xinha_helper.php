...
?>
    ...
    <script type="text/javascript" >
        ...
        xinha_init = xinha_init ? xinha_init : function()
        {
         ...
         // THIS BIT OF JAVASCRIPT LOADS THE PLUGINS, NO TOUCHING  <img draggable="false" class="emoji" alt="🙂" src="https://s0.wp.com/wp-content/mu-plugins/wpcom-smileys/twemoji/2/svg/1f642.svg">
